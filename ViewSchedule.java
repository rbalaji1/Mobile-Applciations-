...
public class ViewSchedule extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Spinner appspinner = (Spinner)findViewById(R.id.spinner5);
        final TextView showdata = (TextView)findViewById(R.id.textView9);
        Button submit = (Button) findViewById(R.id.button35);
        ...
        adapter = new ArrayAdapter<String>(ViewSchedule.this, R.layout.list_item, R.id.txtName, apps);
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    for (int i = 0; i < jArray.length(); i++) {
                        ...
                        ap.setRuntime(json_data.getInt("runtime"));
                        ap.setStartime(json_data.getInt("starttime"));
                        ap.setCurrentstart(json_data.getInt("currentstart"));
                        ap.setCurrentstart(json_data.getInt("currentend"));
                        ap.setTaskid(json_data.getInt("taskid"));
                ...
                data = pos + "\n" + "Appliance name    : " + ap.getAppliancename() + "\n" +
                        ...
                        "Current start time : " + ap.getCurrentstart() + "\n" +
                        "Current end time : " + ap.getCurrentend() + "\n" +
