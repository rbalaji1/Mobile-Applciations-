...
public class ViewUtilSchedule extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_util_schedule);



        Button back = (Button)findViewById(R.id.button32);
        Button acceptutil = (Button)findViewById(R.id.button34);
        Button sendh = (Button)findViewById(R.id.button38);
        TextView show = (TextView)findViewById(R.id.textView26);
        ...
        String conResult = getConnection("http://"+IPutil+"/getustime.php", name);
        ...
        try {
            ...
            for (int i = 0; i < jArray.length(); i++) {
                ...
                ap.setUsstarttime(json_data.getInt("usstarttime"));
        ...
        for(int i=0; i<appliance.size();i++){
            ...
            data = data + "Appliance Name :  " +  appliance.get(i).getAppliancename() + "\n" +
                    "Scheduled Start time :  " + appliance.get(i).getUsstarttime() + "\n" +
                    "Scheduled end time   :  " + (appliance.get(i).getUsstarttime() + (appliance.get(i).getRuntime()*100)) + "\n";
        ...
        sendh.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                for (int i = 0; i < appliance.size(); i++) {
                    ...
                    String start = Integer.toString(appliance.get(i).getUsstarttime());
                    String apname =  appliance.get(i).getAppliancename();

                    String Resulthome = getConnection("http://" + IPhome + "/putusstart.php", name, apname, start);
        ...
        acceptutil.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                for(int i=0; i<appliance.size(); i++){
                    String apname =  appliance.get(i).getAppliancename();
                    String start = Integer.toString(appliance.get(i).getUsstarttime());
                    int e = (appliance.get(i).getUsstarttime() + (appliance.get(i).getRuntime()*100));
                    String end = Integer.toString(e);

                    String Resulthome = getConnection("http://" + IPhome + "/acceptutil.php", name, apname, start, end);


                }
                Toast.makeText(getBaseContext(), "Utility Schedule Accepted at home", Toast.LENGTH_SHORT).show();
                ...
                for(int i=0; i<appliance.size(); i++){
                    ...
                    String Resultutil = getConnection("http://"+IPutil+"/acceptutil.php", name, apname, start, end);

                }
                Toast.makeText(getBaseContext(), "Utility Schedule Accepted at utility", Toast.LENGTH_SHORT).show();
    ...
    public String getConnection(String url, String usr, String apname, String start) {
        ...
        nameValuePairs1.add(new BasicNameValuePair("usstarttime", start));
